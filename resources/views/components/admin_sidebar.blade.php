<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item {{ request()->routeIs('admin.users.*') ? 'active' : ''}}"><a class="nav-link" href="{{ route('admin.users.index') }}"><i class="fas fa-user"></i> <span>Users</span></a></li>
            <li class="nav-item {{ request()->routeIs('admin.agents.*') ? 'active' : ''}}"><a class="nav-link" href="{{ route('admin.agents.index') }}"><i class="fas fa-user-tie"></i> <span>Agents</span></a></li>
        </ul>
    </aside>
</div>
